...
INSERT INTO `cheat_types` (`cheatid`, `name`, `description`, `argument`, `action_bitmask`, `warning_message`) VALUES(7, 'MOGSAFE', 'Player is using a tool to access storage outside their mog house', 0, 13, 'An attempt was made to access your mog storage outside your residence. Further infractions will result in autojail.');
